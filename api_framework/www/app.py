...
from models.mongodb import mongodb_orm
from models.es import es_orm
...
@asyncio.coroutine
def init(loop):
	es_orm.create_es_client(**configs.es)
	yield from mongodb_orm.create_client(**configs.mongo_db)
